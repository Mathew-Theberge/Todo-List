...
editTaskModal.addEventListener("click", (e) => {
    if (isSelectInputClickedInFirefox === true) {
        ...
        setTimeout(
            () => closeModalOnOutsideClick(e, editTaskModal, editTaskForm),
            5,
        );
    }
});
...
newTaskModal.addEventListener("click", (e) => {
    if (isSelectInputClickedInFirefox === true) {
        ...
        setTimeout(
            () => closeModalOnOutsideClick(e, newTaskModal, newTaskForm),
            5,
        );
    }
});
...
newProjectModal.addEventListener("click", (e) => {
    setTimeout(
        () => closeModalOnOutsideClick(e, newProjectModal, newProjectForm),
        5,
    );
});
