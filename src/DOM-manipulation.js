...
export const changeProjectFolder = document.querySelector(
    "#changeProjectFolder",
);
...
export const emptyFolderNewTaskBtn = document.querySelector(
...
export function renderFolderBtns(manualCallback = false) {
    ...
    allFoldersArray.forEach((folder) => {
        ...
        const pathFolder = document.createElementNS(
            "http://www.w3.org/2000/svg",
            "path",
        );
        const svgTrashCan = document.createElementNS(
